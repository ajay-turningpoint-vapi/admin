                                ...
                                <DashboardBox>
                                    <div className="row">
                                                    ...
                                                    isVideo ?
                                                        <>
                                                            {fileUrl && fileUrl?.name ?
                                                                <div className="mb-3">Your selected file is <b>{fileUrl?.name}</b></div>
                                                                :
                                                                <video width="220" height="150" src={generateFilePath(fileUrl)} controls autoPlay={false}>
                                                                </video>
                                                            }
                                                        </>
                                                        :
                                                        <>
                                                            {fileUrl && fileUrl?.includes("base64") ?
                                                                <img height="84px" width="56px" alt={"asd"} src={fileUrl} />
                                                                :
                                                                <img height="84px" width="56px" alt={"asd"} src={generateFilePath(fileUrl)} />
                                                            }
                                                        </>
                                                }
                                            </div>
                                            <FileUpload onFileChange={handleFileChange} getVideoDuration={true} />
                                        </div>
                                        <hr />
                                            ...
                                            <div className="col-12">
                                                <div className="row">
                                                    <div className="row d-flex justify-content-between">
                                                        <div className="col-5">
                                                            <div className="row">
                                                                <label htmlFor="">Enter Time in seconds to display like button after</label>
                                                                <input className="border rounded me-3 py-2" type={"number"} onChange={(e) => setDisplayLikeAfter(e.target.value)} value={displayLikeAfter} />
                                                            </div>
                                                        </div>
                                                        <div className="col-5">
                                                            <div className="row">
                                                                <label htmlFor="">Points</label>
                                                                <input className="border rounded me-3 py-2" type={"number"} onChange={(e) => setPoints(e.target.value)} value={points} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-12 mt-2">
                                            <CustomButton btntype="button" isDisabled={disableSubmitButton} ClickEvent={handleSubmit} isBtn iconName="fa-solid fa-check" btnName={"Update"} />
                                        </div>
                                    </div>
                                </DashboardBox>
                            </div>
